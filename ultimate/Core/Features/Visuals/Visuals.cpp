											...
											for (int i = 0; i < Renderers_Size; i++) {
												...
												if (IsAddressValid(MainRenderer))
												{
													...
													if (!IsAddressValid(material))
														continue;
													auto ChamsColor = Color{ ColorSettings::VisibleChams_Color.r * m_settings::glowvalue, ColorSettings::VisibleChams_Color.g * m_settings::glowvalue, ColorSettings::VisibleChams_Color.b * m_settings::glowvalue, ColorSettings::VisibleChams_Color.a };
									...
									if (name->c_str())
									{
											...
											name->Contains("Tarp") || name->Contains("Targeting Computer"))
										{
											...
											if (m_settings::DroppedItemsChams) {
												auto ChamsColor = Color{ ColorSettings::DroppedChams_Color.r * m_settings::glowvalue, ColorSettings::DroppedChams_Color.g * m_settings::glowvalue, ColorSettings::DroppedChams_Color.b * m_settings::glowvalue, ColorSettings::DroppedChams_Color.a };
