...
void ChamsTab()
{
    if (auto groupbox_ctx = calliope::menu.components.groupbox(XS("PlayerChams"), calliope::vec2_t(50, 0), calliope::vec2_t(groupbox_sz, small_chams_tab))) {
        ...
        calliope::menu.components.checkbox(XS("Player-Chams"), m_settings::PlayerChams);
            ...
            calliope::menu.components.colorpicker(XS("Chams-Color"), ColorSettings::VisibleChams_Color, false);
    ...
    if (auto groupbox_two = calliope::menu.components.groupbox(XS("Weapon Chams"), calliope::vec2_t(60 + groupbox_sz, 0), calliope::vec2_t(groupbox_sz, groupbox_sz_y - 10))) {
        ...
        calliope::menu.components.checkbox(XS("Arm-Chams"), m_settings::IgnoreArms);

        calliope::menu.components.colorpicker(XS("Weapon-Chams-Color"), ColorSettings::weapon_chamss, false);
        calliope::menu.components.colorpicker(XS("Arm-Chams-Color"), ColorSettings::armm_chamss, false);
        calliope::menu.components.slider<float>(XS("Glow Value"), XS(""), m_settings::glowvalue, 1, 50);
...
void WorldTab()
{
    ...
    if (WorldPage == 0) {
        ...
        if (auto groupbox_ctx_2 = calliope::menu.components.groupbox(XS("Ores"), calliope::vec2_t(50, WorldStartSize + 10 + small_world_tab), calliope::vec2_t(groupbox_sz, groupbox_sz_y - small_world_tab2 - WorldStartSize - 5))) {
           ...
           // calliope::menu.components.checkbox(XS("Icon-Ores"), m_settings::OreIcons);
...
void LocalTab()
{
    ...
    if (LocalPage == 0) {
        if (auto groupbox_ctx2 = calliope::menu.components.groupbox(XS("Movement"), calliope::vec2_t(50, LocalStartSize), calliope::vec2_t(groupbox_sz, groupbox_sz_y - LocalStartSize - 15))) {
            ...
            calliope::menu.components.checkbox(XS("High-Jump"), m_settings::highjump);
            calliope::menu.components.slider<float>(XS("Jump Value"), XS(""), m_settings::highjumpf, 100, 150);
...
void WeaponsTab()
{
    if (auto groupbox_ctx = calliope::menu.components.groupbox(XS("Weapon"), calliope::vec2_t(50, 0), calliope::vec2_t(groupbox_sz, small_weapons_tab))) {
        ...
        calliope::menu.components.checkbox(XS("No-Spread"), m_settings::NoSpread);
...
void GUI::DrawMenu()
{
    if (calliope::menu.components.window(XS(""), calliope::vec2_t(250, 250), calliope::vec2_t(600, 400), calliope::menu_t::window_flags_none)) {
