...
void Configs::SaveConfig()
{
    ...
    LI_FN(fclose)(file);
    config.clear();
    const auto string = std::wstring(XS(L"[MrKouhx] Saved Config!"));
...
void Buttons::ClearRaidCache() {
    ...
    const auto string = std::wstring(XS(L"[MrKouhx] Cleared Raid Cache!"));
    notifcations::object.push(string.c_str(), UnityEngine::Time::get_time());
}
...
void Buttons::ClearLOSPoints() {
    ...
    const auto string = std::wstring(XS(L"[MrKouhx] Reset LOS Points!"));
    notifcations::object.push(string.c_str(), UnityEngine::Time::get_time());
}
...
void Buttons::LoadLegitCheat() {
    ...
    const auto string = std::wstring(XS(L"[MrKouhx] Loaded Legit Menu!"));
    notifcations::object.push(string.c_str(), UnityEngine::Time::get_time());
}
...
void Buttons::LoadRageCheat() {
    ...
    const auto string = std::wstring(XS(L"[MrKouhx] Loaded Rage Menu!"));
    notifcations::object.push(string.c_str(), UnityEngine::Time::get_time());
}